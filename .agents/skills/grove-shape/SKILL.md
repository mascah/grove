...
The shaping request is in the message that invoked this skill: a topic in the caller's own words and/or
...
mode. `AGENTS.md` is this repository's development policy, including how the
