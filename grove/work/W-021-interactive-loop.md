...
size: small
priority: 1
depends_on: ["W-011", "W-019", "W-020"]
relates_to: ["D-004", "W-018"]
---
...
Use delivered W-011/W-019/W-020 behavior on a newly selected, bounded real change.
...
After prerequisites land, select the real change and write a short trial outline
at `docs/plans/W-021-interactive-loop.md`; no elaborate task plan is needed.
