...
W-001 is done and every record so far was numbered by hand. The next planned
...
- Keep W-001's reader unchanged in behavior; reuse it to validate the project
...
[D-003](../decisions/D-003-allocator-mechanism.md) proposes the mechanism:
