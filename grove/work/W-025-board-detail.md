...
priority: 3
depends_on: ["W-024"]
relates_to: ["D-004", "W-009", "W-012", "W-023", "W-026", "D-006", "W-030"]
---
...
Use W-024's project-wide projection. Board columns follow the target lifecycle;
...
also makes W-030's general knowledge discoverable without turning it into work
...
but implement review actions in W-026. Use Bubble Tea v2 with compatible Charm
...
CLI with visual examples using real records and W-023 feedback. Check dependency
