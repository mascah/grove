...
id: "R-001"
type: review
title: "Independent review of W-019 knowledge records"
status: current
...
[W-019](../work/W-019-knowledge-artifacts.md) against its acceptance,
[D-005](../decisions/D-005-typed-knowledge-records.md) and its
[plan](../../docs/plans/W-019-knowledge-artifacts.md). An independent reviewer
...
`fc9bef1`, which `examined` names. This record and W-019's reconciliation were
...
of W-019, including the nine terms, is separate and outstanding.
