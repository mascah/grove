...
relates_to: ["D-001", "D-002", "D-005", "W-019", "W-030", "W-029", "W-018"]
---

## Decision and authority

On 2026-09-21, after W-019 was integrated, the owner reopened both mandatory
type folders and the closed set of knowledge types before assigning W-029.
...
The [brief](../../docs/restart-brief.md) owns the selected direction:
...
This revises D-001/D-005's required type folders and D-002/D-005's type-bound
identity for future creation. It preserves sequential allocation across local
worktrees, revision-checked writes, W-019's useful types and artifact links,
the one brief, and W-020's ownership of review/approval semantics. W-019 remains
completed evidence of schema 2, not work to reopen or undo.

## Delivery boundary

[W-030](../work/W-030-flexible-records.md) owns compatible schema/CLI support.
[W-029](../work/W-029-migrate-knowledge.md) follows with a complete one-time
...
ordinary edits or completion, and not an assignment to execute W-029 now. Do
...
typed creation commands. W-030's preparation settles exact schema version,
