# Predecessor `/work` review for W-010
...
prompt-writing problem behind W-010; do not confuse its name with a runner.
...
| Responsibility | W-010 treatment |
| --- | --- |
...
| Implementer/reviewer coordination | Choose and document supported harness behavior during W-010 preparation. Do not silently imply controller parity from a prompt template. |
...
The current [execution guide](../work-execution.md) covers only part of this
behavior. It is a useful baseline, not a replacement proven equivalent to the
old `/work`. [W-010](../../grove/work/W-010-work-handoffs.md) must explain what
