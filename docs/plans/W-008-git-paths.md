# W-008 Git path identity implementation plan
...
**Spec:** [W-008](../../grove/work/W-008-git-paths.md).
...
- [ ] Switch versions and allocation to `repo.Worktrees`; remove the allocator's
  ...
  counter protocol unchanged. Reuse W-006's new administrative validity checks
