...
**Spec:** [W-012](../../grove/work/W-012-card-lineage.md). On 2026-09-20 the
owner selected "beside, history first": the card screen and its version list
stay as they are (Q-001 still needs an explicit version selection), and History
